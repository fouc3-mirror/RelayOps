<?php /*a:2:{s:59:"D:\frps-tp\RelayOps-php\app\install/view/install\step4.html";i:1782529589;s:52:"D:\frps-tp\RelayOps-php\app\install/view/layout.html";i:1782526748;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>管理员配置 - RelayOps安装向导</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<h2 style="margin-bottom: 20px; color: #333;">管理员配置</h2>
...
<form id="adminForm">
    ...
    <div class="form-group">
        ...
        <input type="password" id="admin_pass" name="admin_pass" placeholder="请输入管理员密码" required>
    </div>

    <div class="form-group">
        <label for="admin_pass_confirm">确认密码</label>
        <input type="password" id="admin_pass_confirm" placeholder="请再次输入密码" required>
    </div>

    <div class="alert alert-info">
        请牢记管理员账号密码，安装完成后将无法修改。
    </div>

    <div class="btn-group">
        <a href="<?php echo url('/install/step3'); ?>" class="btn btn-secondary">上一步</a>
...
<script>
    function nextStep() {
        ...
        window.location.href = '<?php echo url("/install/step5"); ?>';
    }
</script>
