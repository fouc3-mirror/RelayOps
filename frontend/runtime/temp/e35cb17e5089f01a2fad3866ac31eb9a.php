<?php /*a:2:{s:59:"D:\frps-tp\RelayOps-php\app\install/view/install\step3.html";i:1782529589;s:52:"D:\frps-tp\RelayOps-php\app\install/view/layout.html";i:1782526748;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>数据库配置 - RelayOps安装向导</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<form id="dbForm">
    ...
    <div class="btn-group">
        <a href="<?php echo url('/install/step2'); ?>" class="btn btn-secondary">上一步</a>
        <div>
            <button type="button" class="btn btn-secondary" onclick="testConnection()" style="margin-right: 10px;">测试连接</button>
...
<script>
    function testConnection() {
        ...
        fetch('<?php echo url("/install/testDb"); ?>', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    function nextStep() {
        ...
        sessionStorage.setItem('db_host', formData.get('db_host'));
        sessionStorage.setItem('db_port', formData.get('db_port'));
        sessionStorage.setItem('db_name', formData.get('db_name'));
        sessionStorage.setItem('db_user', formData.get('db_user'));
        sessionStorage.setItem('db_pass', formData.get('db_pass'));
